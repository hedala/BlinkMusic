...
from BlinkMusic.platforms.Telegram import TeleAPI
from pytgcalls.exceptions import NoActiveGroupCall

import config
from config import BANNED_USERS, lyrical
from strings import get_command
from BlinkMusic import Apple, Resso, SoundCloud, Spotify, Telegram, YouTube, app, userbot
from BlinkMusic.core.call import Blink
from BlinkMusic.utils import seconds_to_min, time_to_seconds
from BlinkMusic.utils.channelplay import get_channeplayCB
from BlinkMusic.utils.database import is_video_allowed
from BlinkMusic.utils.decorators.language import languageCB
from BlinkMusic.utils.decorators.play import PlayWrapper
from BlinkMusic.utils.formatters import formats
from BlinkMusic.utils.inline.play import (
    livestream_markup,
    playlist_markup,
    slider_markup,
    track_markup,
)
from BlinkMusic.utils.inline.playlist import botplaylist_markup
from BlinkMusic.utils.logger import play_logs
from BlinkMusic.utils.stream.stream import stream
    ...
    if audio_telegram:
        ...
        if TeleAPI.validate(url):
            ...
            if msg:
                ...
                return play_commnd(client, message, _, chat_id, video, channel, playmode, url, fplay)
...
async def play_music(client, CallbackQuery, _):
    ...
    if details["duration_min"]:
        ...
        if duration_sec > config.DURATION_LIMIT:
            return await mystic.edit_text(
                _["play_6"].format(config.DURATION_LIMIT_MIN,
                                   details["duration_min"])
            )
    else:
        buttons = livestream_markup(
...
@app.on_callback_query(filters.regex("BlinkPlaylists") & ~BANNED_USERS)
@languageCB
